...
namespace WebAPI.Extensions
{
    ...
    {
        public static async Task GetSchedulesDatesAsync(this GetSchedulesDatesRequestDto request, UnitOfWork unitOfWork, GetSchedulesDatesResponseDto response, IMapper mapper)
        {
            ...
            response.SchedulesDates = mapper.Map<List<SchedulesDatesViewDto>>(result);
        }
    }
}
